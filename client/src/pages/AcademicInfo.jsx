      ...
      {(auth.role === 'dept_admin' || auth.role === 'admin') ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '0.85rem', color: '#64748b' }}>
                  {auth.role === 'dept_admin' 
                    ? 'View official academic and publication identification profile of department faculty (Read-Only)' 
                    : 'Manage official academic and publication identification profile of department faculty'}
                </p>
              </div>
              <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap', flex: 1, justifyContent: 'flex-end' }}>
                ...
                <div style={{ position: 'relative', display: 'flex', alignItems: 'center', minWidth: '280px', flex: 1 }}>
                  ...
                  <input
                    type="text"
                    className="form-control"
                    placeholder="Search by ID, Name, AICTE, AU, APAAR..."
                    value={searchQuery}
          ...
          {selectedFacultyTarget && (
            <div style={{ position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.65)', display: 'flex', alignItems: 'center', justify: 'center', zIndex: 1000, padding: '20px' }}>
              <div className="card" style={{ maxWidth: '680px', width: '100%', maxHeight: '90vh', overflowY: 'auto', background: '#ffffff', color: '#111827', border: '1px solid hsl(var(--border))', boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.4)' }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '20px', borderBottom: '1px solid #e2e8f0', paddingBottom: '12px' }}>
                  <div>
                    <h3 style={{ fontSize: '1.3rem', color: '#0f172a', fontWeight: 800 }}>Academic Info: {selectedFacultyTarget.staff_name}</h3>
