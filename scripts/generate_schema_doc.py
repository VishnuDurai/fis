...
TABLE_DESCRIPTIONS = {
    ...
    "event_design_templates": "Master catalog of institutional design templates for Event Posters (P01-P05), Formal Invitations (I01-I05), and Participation Certificates (C01-C05).",
    "event_generated_documents": "Audit and history repository tracking all posters, invitations, and bulk certificate batches generated by faculty members."
}
