...
<html class="no-js">
    <head>
        ...
        <title>Research Supervisor | Details &#183; SRECFIS</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-striped table-bordered" id="myTable">
                    ...
                    <?php 
                       require('../models/dbcon.php');
                       $sql = mysqli_query($conn,"select a.Department,i.staff_id,i.res_sup_id,i.staff_name,i.university,i.internal,i.external,i.scholar from staff_academics a,staff_supervisor i where i.staff_id=a.staff_id and a.Department='".$dept."'");
                       while($row = mysqli_fetch_array($sql))
                       {
                        $staff_id = $row['staff_id'];
                        $res_sup_id = $row['res_sup_id'];
