...
<html class="no-js">
    <head>
        ...
        <title>Club Activity | Details &#183; SRECFIS</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-striped table-bordered" id="myTable">
                    ...
                    <?php 
                       require('../models/dbcon.php');
                       $sql = mysqli_query($conn,"select a.Department,a.staff_name,i.staff_id,i.club,i.res_person,i.type,i.title,i.ben_person,i.from_date,i.to_date,i.organizer,i.sponsership,i.granted,i.file from staff_academics a,staff_club i where i.staff_id=a.staff_id and a.Department='".$dept."' order by i.from_date");
