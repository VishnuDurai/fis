...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="../controllers/fetch_supervisor.php">
     <center><h3 style="color: #682D87;">Research Supervisor Details</h3></center>
      ...
      <div class="form-container offset-sm-4">
        <div class="form-group">
          ...
          <input type="number" class="form-control col-sm-4" name="staffid">&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="submit" class="btn btn-info" style="cursor:pointer;" name="Getid" value="Staff Report">
        </div></div>
        <div class="form-group">
          <label style="color: white;">ResearchSupervisorID</label>
          <div class="form-inline">
          <input type="number" class="form-control col-sm-4" name="resid">&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="submit" class="btn btn-info" style="cursor:pointer;" name="schid" value="Research Supervisor Report">
        </div></div>
        <div class="form-group has-error">
          ...
          <!-- <select name="dept" class="form-control col-sm-6">
           ...
           <input type="submit" name="GetDept" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Department Report"></div></div><br>
