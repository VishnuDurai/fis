...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="../controllers/fetch_scholarstable.php">
     <center><h3 style="color: #682D87;">Research Scholars Details</h3></center>
      <hr>
      <div class="form-container offset-sm-4">
        ...
        <div class="form-group">
          <label style="color: white;">Research Scholars ID</label>
          <div class="form-inline">
          <input type="number" name="supid" class="form-control col-sm-4">&nbsp;&nbsp;&nbsp;&nbsp;
          <input type="submit" class="btn btn-info" style="cursor:pointer;" name="Getsupid" value="Research Scholars Report">
        </div></div>
        <div class="form-group has-error">
          ...
          <!-- <select name="dept" class="form-control col-sm-6">
           ...
           <input type="submit" class="btn btn-info" style="cursor:pointer;" name="GetDept" value="Department Report"></div></div>
           <div class="form-group">
...
<a href="../views/home.php"><input type="button" class="btn btn-danger offset-sm-0" style="cursor:pointer;" value="BACK"></a>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <input type="submit" class="btn btn-success" style="cursor:pointer;" name="GetDPR" value="Department Status Report">
        </div>
    </div><br>
      <br><hr>
</form>
