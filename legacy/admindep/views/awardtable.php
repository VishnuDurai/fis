...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="../controllers/fetch_award.php">
     <center><h3 style="color: #682D87;">Award Details</h3></center>
      <hr>
      <div class="form-container offset-sm-4"><br>  <div class="form-group">
        ...
        <div class="form-group has-error">
          ...
          <div class="form-inline">
            <input type="text" class="form-control col-sm-4" name="dept" value="<?php echo $dept; ?>"  style='background-color:white; font-weight:bold;' readonly>&nbsp;&nbsp;&nbsp;&nbsp;              <option value="#">----------</option>
