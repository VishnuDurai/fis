...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="../controllers/fetch_resource.php">
      ...
      <div class="form-container offset-sm-4">
        <div class="form-group has-error">
          ...
          <div class="form-inline">
           ...
           <option value="dtr" name="GetCol">Periodic Department Type Report</option>
           </select></div></div>
         ...
         <a class="fa fa-refresh w3-xlarge w3-spin" href="resourcetable.php"></a>
           &nbsp;&nbsp;&nbsp;&nbsp;
