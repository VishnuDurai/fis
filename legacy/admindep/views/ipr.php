...
<html class="no-js">
    <head>
        ...
        <title>IPR | Details &#183; SRECFIS</title>
        ...
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="col-sm-7 text-center">
                        <h3>Intellectual Property Right Details</h3>
                    </div>
                    <div class="col-sm-3">
                    &nbsp;&nbsp;
                ...
                <table class="table table-striped table-bordered" id="myTable">
                    ...
                    <?php 
                       require('../models/dbcon.php');
                       $sql = mysqli_query($conn,"select a.Department,i.file,i.staff_id,i.staff_name,i.patent,i.institution,i.generation,i.propose from staff_academics a,staff_ipr i where i.staff_id=a.staff_id and a.Department='".$dept."'");
