...
<html class="no-js">
    <head>
        ...
        <title>Professional | Details &#183; SRECFIS</title>
    ...
    <?php include('../views/navbar.php');?>
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="col-sm-3">
                    &nbsp;&nbsp;
                    <a class="btn btn-success" href="excel_professional.php"><i class="fa fa-download" aria-hidden="true"></i>&nbsp; Export Excel</a>
                    </div>
                </div>
                <p>&nbsp;</p>
                <table class="table table-striped table-bordered" id="myTable">
                    ...
                    <?php 
                       require('../models/dbcon.php');
                       $sql = mysqli_query($conn,"select a.Department,a.Designation,i.id,i.staff_id,i.staff_name,i.membershipid,i.organization from staff_academics a,staff_member i where i.staff_id=a.staff_id and a.Department='".$dept."' order by i.organization");
