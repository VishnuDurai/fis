...
$result1 = mysqli_query($conn,"select * from professional");
...
<body>
  ...
  <div class="container">
    ...
    <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
      <form method="post" action="../controllers/fetch_professional.php">
       <center><h3 style="color: #682D87;">Professional Details</h3></center>
        ...
        <div class="form-container offset-sm-4"><br>
          ...
          <a href="../views/home.php"><input type="button" class="btn btn-danger offset-sm-1" style="cursor:pointer;" value="BACK"></a>
           &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
