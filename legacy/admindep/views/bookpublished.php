...
<html class="no-js">
    <head>
        ...
        <title>Book Published | Details &#183; SREC FIS</title>
    ...
    <?php include('../views/navbar.php');?>
        <div class="container-fluid">
            ...
            <table class="table table-striped table-bordered" id="myTable">
                ...
                <?php 
                require('../models/dbcon.php');
                $sql = mysqli_query($conn,"select a.Department,i.staff_id,i.staff_name,i.title,i.coauthor,i.publisher,i.edition,i.isbn,i.file,i.dateofpublication from staff_academics a,staff_book_published i where i.staff_id=a.staff_id and a.Department='".$dept."'");
