...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="../controllers/fetch_staff_individual.php">
     <center><h3 style="color: #682D87;">Individual Staff List</h3></center>
      <hr>
    ...
    <!-- <div class="form-group">
       ...
       <a href="../views/home.php"><input type="button" class="btn btn-danger w3-animate-bottom w3-hover-black" style="cursor:pointer;" value="BACK"></a>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" class="btn btn-warning w3-animate-bottom w3-hover-orange" style="cursor:pointer;" name="GetAll" value="Periodic Staff Report">&nbsp;&nbsp;
      </div>
    </div><br>
      <br><hr>
</form>
