...
<html>
<head>
<title>Event Organized Table</title>
...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="../controllers/fetch_eventtable.php">
      ...
      <div class="form-container offset-sm-4">
        <div class="form-group has-error">
          ...
          <!-- <select name="dept" class="form-control col-sm-6">
           ...
           <input type="submit" name="GetDept" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Department Report"></div></div>
           <div class="form-group">
           <label style="color: white;">Report Table</label>
           <div class="form-inline">
           <select name="rtype" id="rtype" class="form-control col-sm-6">
           <option value="#">-------------</option>
           <option value="dpr" name="GetDPR">Department Periodic Report</option>
           <option value="dtr" name="GetCol">Department Type Periodic Report</option>
           </select></div></div>
        <div class="form-group typ">
            <label style="color: white;">Type</label>
            <div class="form-inline">
          <select name="typ" id="typ" class="form-control col-sm-6">
           <option value="#">-----------</option>
           <option>FDP</option>
         ...
         <a class="fa fa-refresh w3-xlarge w3-spin" href="researchtable.php"></a>
           &nbsp;&nbsp;&nbsp;&nbsp;
         <a href="../views/home.php"><input type="button" class="btn btn-danger" style="cursor:pointer;" value="BACK"></a>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <!-- <input type="submit" class="btn btn-success" style="cursor:pointer;" name="submit" value="Department Periodic Type Report">&nbsp;&nbsp;
        <input type="submit" class="btn btn-success" style="cursor:pointer;" name="getDPR" value="Department Periodic Report">&nbsp;&nbsp; -->
        <input type="submit" class="btn btn-success w3-hover-orange" style="cursor:pointer;" name="GetReport" value="Fetch Report">
      </div>
    </div><br>
      <br><hr>
</form>
