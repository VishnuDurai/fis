...
<html class="no-js">
    <head>
        ...
        <title>Award | Details &#183; SRECFIS</title>
    ...
    <?php include('../views/navbar.php');?>
        <div class="container-fluid">
            <div class="row">
                    ...
                    <div class="col-sm-3">
                    &nbsp;&nbsp;
                    <a class="btn btn-success" href="excel_awards.php"><i class="fa fa-download" aria-hidden="true"></i>&nbsp; Export Excel</a>
                    </div>
                </div>
                <p>&nbsp;</p>
                <table class="table table-striped table-bordered" id="myTable">
                    ...
                    <?php 
                       require('../models/dbcon.php');
                       $sql = mysqli_query($conn,"select a.Department,i.file,i.staff_id,i.staff_name,i.awardname,i.awardby,i.event,i.awa_date from staff_academics a,staff_award i where i.staff_id=a.staff_id and a.Department='".$dept."' order by i.awa_date");
