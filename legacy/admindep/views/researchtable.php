...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="../controllers/fetch_research.php">
     <center><h3 style="color: #682D87;">Research and Development</h3></center>
      <hr>
      <div class="form-container offset-sm-4">
       ...
       <!-- <select name="dept" class="form-control col-sm-6">
        ...
        <option value="dtr" name="GetCol">Department Periodic Type Report</option>
        </select></div></div>
          <div class="form-group type">
            <label style="color: white;">Type</label>
            <div class="form-inline">
          <select name="type" id="type" class="form-control col-sm-6">
           <option value="#">-----------</option>
