...
<html class="no-js">
    <head>
        ...
        <title>Event Organized | Details &#183; SRECFIS</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-striped table-bordered" id="myTable">
                    ...
                    <?php 
                       require('../models/dbcon.php');
                       $sql = mysqli_query($conn,"select a.Department,a.staff_name,i.staff_id,i.res_person,i.type,i.title,i.ben_person,i.from_date,i.to_date,i.organizer,i.sponsership,i.granted,i.file from staff_academics a,staff_event_organized i where i.staff_id=a.staff_id and a.Department='".$dept."' order by i.from_date");
                       while($row = mysqli_fetch_array($sql))
                       {
                        ...
                        $res_person = $row['res_person'];
                        $ben_person = $row['ben_person'];
                        $sponsership = $row['sponsership'];
                        $granted = $row['granted'];
                        $file = $row['file'];
                     ?>
                        <tbody>
                        ...
                        <td><?php echo $ben_person; ?></td>
                        <td><?php echo $sponsership; ?></td>
                        <td><?php echo $granted; ?></td>
                        <td><a href="../../admin/document/<?php echo $file?>"><button class="btn btn-defalut">View</button></a></td>
                        </tbody>
                        <?php
                       }?>
                    </table>
