...
<html class="no-js">
    <head>
        ...
        <title>Funding | Details &#183; SRECFIS</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-striped table-bordered" id="myTable">
                    ...
                    <?php 
                       require('../models/dbcon.php');
                       $sql = mysqli_query($conn,"select a.Department,i.staff_id,i.staff_name,i.copiid,i.copiname,i.fa,i.amount,i.date,i.title,i.status,i.referenceno,i.file from staff_academics a,staff_funding i where a.staff_id = i.staff_id and a.Department='".$dept."'");
                       while($row = mysqli_fetch_array($sql))
                       {
                        $id = $row['staff_id'];
	                    $piname = $row['staff_name'];
	                    $coname = $row['copiname'];
	                    $coid = $row['copiid'];
                        $title = $row['title'];
                        $faa = $row['fa'];
