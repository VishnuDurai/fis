...
$result1 = mysqli_query($conn,"select * from club");
?>
<!DOCTYPE html>
<html>
<head>
...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="../controllers/fetch_clubtable.php">
     <center><h3 style="color: purple;">Club Activities</h3></center>
      ...
      <div class="form-container offset-sm-4">
        ...
        <option value="#">------------</option>
        <option value="pcr" name="GetPCR">Periodic Club Type Report</option>
        <option value="cpr" name="getDPR">Club Periodic Report</option>
        </select></div></div>
