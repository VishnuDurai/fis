...
<html class="no-js">
    <head>
        ...
        <title>Pan | Details &#183; SRECFIS</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-striped table-bordered">
                    ...
                    <?php 
                       require('../models/dbcon.php');
                       $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_id,i.staff_name,i.path1 from staff_academics a,staff_pan i where i.staff_id=a.staff_id and a.Department='".$dept."'");
