...
<html class="no-js">
    <head>
        ...
        <title>Online Certificate | Details &#183; SRECFIS</title>
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <table class="table table-striped table-bordered" id="myTable">
                    ...
                    <?php 
                       require('../models/dbcon.php');
                       $sql = mysqli_query($conn,"select a.Department,i.file,i.staff_id,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_certificate i where i.staff_id=a.staff_id and a.Department='".$dept."'order by i.data_of_exam");
                       while($row = mysqli_fetch_array($sql))
                       {
                        $staff_id = $row['staff_id'];
                        $staff_name = $row['staff_name'];
                        $patent = $row['course_name'];
                        $institution = $row['mark'];
                        $generation = $row['organisation'];
                        $data_of_exam = $row['data_of_exam'];
                        $file = $row['file'];
                     ?>
                        <tbody>
