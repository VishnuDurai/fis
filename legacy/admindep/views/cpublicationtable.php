...
<html>
<head>
	<title>Table Conference Publication</title>
...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="../controllers/fetch_cpublication.php">
     <center><h3 style="color: #682D87;">Conference Publication Details</h3></center>
      <hr>
      <div class="form-container offset-sm-4">
        <div class="form-group has-error">
         ...
         <a class="fa fa-refresh w3-xlarge w3-spin" href="cpublicationtable.php" style="color: black;"></a>
         &nbsp;&nbsp;&nbsp;&nbsp;
         <a href="../views/home.php"><input type="button" class="btn btn-danger" style="cursor:pointer;" value="BACK"></a>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" class="btn btn-success" style="cursor:pointer;" name="submit" value="Department Peroidic Report">&nbsp;&nbsp;
        </div>
    </div><br>
      <br><hr>
</form>
