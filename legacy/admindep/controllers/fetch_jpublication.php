...
<a href="../views/jpublicationtable.php"><button type="button" style=" cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
<div class="wrapper">
       ...
       ?>
         ...
         <thead class="table-sm table-success">
           <tr>
             ...
             <th style="width:100px; text-align:center;">Scopus Indexed</th>
...
while($row = mysqli_fetch_array($sql)){
  ...
  $s++;
      ...
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.month_pub,i.volume_pub,i.pp,i.index_pub,i.web_of_science from staff_academics a,staff_publication i where a.staff_id = i.staff_id order by a.Department,a.Designation desc,i.month_pub");
      $s =1;
      while($row = mysqli_fetch_array($sql)){
        $name = $row['staff_name'];
        $des = $row['Designation'];
