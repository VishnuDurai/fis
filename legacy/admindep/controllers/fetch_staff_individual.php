...
<a href="../views/individual_list.php"><button type="button" style=" cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
<div class="wrapper">
...
?>
   ...
   <?php
     ...
     mysqli_set_charset($conn,"UTF8");
     if(isset($_POST['submit1'])){
       $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_id,i.staff_name,i.copiid,i.copiname,i.fa,i.amount,i.date,i.title,i.status,i.referenceno from staff_academics a,staff_funding i where a.staff_id = i.staff_id and a.staff_id='".$_POST['staffid']."'order by i.date");
       if(mysqli_num_rows($sql) != null){
       $s =1;?>
...
?>
  ...
  require ('../models/dbcon.php');
  if(isset($_POST['submit1'])){
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.month_pub");
    if(mysqli_num_rows($sql) != null){
    $s =1;?>
...
if(isset($_POST['GetAll'])){
  $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and month_pub between '".$_POST['from']."' and '".$_POST['to']."' order by i.month_pub");
  if(mysqli_num_rows($sql) != null){
  $s =1;?>
  <b>Journal Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
require ('../models/dbcon.php');
if(isset($_POST['submit1'])){
  $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.date_con");
 if(mysqli_num_rows($sql) != null){
 $s =1;?>
 ...
 echo "";
  ...
  $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and date_con between '".$_POST['from']."' and '".$_POST['to']."' order by i.date_con");
  if(mysqli_num_rows($sql) != null){
  $s =1;?>
  <b>Conference Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
$s++;
 ...
 ?>
   ...
   <center>
    ...
    require ('../models/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_certificate i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.data_of_exam");
if(mysqli_num_rows($sql) != null){
$s =1;?>
...
$s++;
    ...
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_member i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.data_of_exam");
if(mysqli_num_rows($sql) != null){
$s =1;?>
<b>Online Certificate Details</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
  ...
  <center>
    ...
    require ('../models/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.project_title,i.description,i.from_date,i.to_date,i.status from staff_academics a,staff_innovative i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.from_date");
if(mysqli_num_rows($sql) != null){
$s =1;?>
