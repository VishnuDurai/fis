...
<a href="../views/clubtable.php"><button type="button" style=" cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
<div class="wrapper">
     ...
     <div class="content">
      ...
      <b><label class="offset-sm-1"></label>&nbsp;<?php echo $depts;?></b>
        ...
        <table class="table table-sm table-bordered">
                ...
                require ('../models//dbcon.php');
              if(isset($_POST['Club'])){
                $sql = mysqli_query($conn,"select a.staff_name,a.Department,a.Designation,i.club,i.type,i.title,i.from_date,i.to_date,i.res_person,i.ben_person,i.sponsership,i.granted from staff_academics a,staff_club i where a.staff_id=i.staff_id and i.club='".$_POST['club']."' order by a.Department,a.Designation desc,i.from_date");
                $s =1;
                while($row = mysqli_fetch_array($sql)){
