...
<a href="../views/individual_department.php"><button type="button" style=" cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
<div class="wrapper">
...
<input type="text" class="form-control col-sm-1" ng-model="ftext2" placeholder="Footer3">
     ...
     <div class="content">
       ...
       <div class="col"><center>
         <div class="col"><center>
           ...
           require('../models/dbcon.php');
           mysqli_set_charset($conn,"UTF8");
           $sql = mysqli_query($conn,"select distinct staff_name,Department,Designation from staff_academics where Department='".$_POST['dept']."'");
           ...
           <?php
            ...
            ?>
            <b><label>Department of </label></b>&nbsp;<b><?php echo $dep;?></b><br>
         </div>
         <div class="col"><center>
           <b><label>Consolidated Department Report </label></b><br>
         </div>
           <div class="col">
    ...
    <center>
     ...
     if(isset($_POST['submit1'])){
       $sql = mysqli_query($conn,"select a.Designation,i.staff_name,i.type,i.title,i.from_date,i.to_date,i.organizer from staff_academics a,staff_interaction i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."'order by a.Designation desc,i.from_date");
     ...
     $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.type,i.title,i.from_date,i.to_date,i.organizer from staff_academics a,staff_interaction i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc,i.from_date");
     if(mysqli_num_rows($sql) != null){
     $s =1;?>
     <b>Interaction Details</b><p>&nbsp;</p>
     <table class="table table-sm table-bordered">
     ...
     while($row = mysqli_fetch_array($sql)){
       ...
       <tbody>
         <td><?php echo $s;?></td>
         <td style="width:200px; text-align:center;"><?php echo $name;?></td>
         <td style="width:200px; text-align:center;"><?php echo $des;?></td><td style="width:200px; text-align:center;"><?php echo $type;?></td>
         <td style="width:200px; text-align:center;"><?php echo $title;?></td>
         <td style="width:200px; text-align:center;"><?php echo $from;?></td>
         <td style="width:200px; text-align:center;"><?php echo $to;?></td>
         <td style="width:200px; text-align:center;"><?php echo $org;?></td>
...
?>
   ...
   <?php
     ...
     mysqli_set_charset($conn,"UTF8");
     if(isset($_POST['submit1'])){
       $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_id,i.staff_name,i.copiid,i.copiname,i.fa,i.amount,i.date,i.title,i.status,i.referenceno from staff_academics a,staff_funding i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."'order by i.date");
       if(mysqli_num_rows($sql) != null){
       $s =1;?>
       ...
       <table class="table table-sm table-bordered">
             <thead class="table-sm table-success">
               <tr>
                 ...
                 <th style="width:100px; text-align:center;">Priciple Investigator/Faculty Name</th>
       ...
       while($row = mysqli_fetch_array($sql)){
         ...
         <tbody>
           ...
           <td style="width:200px; text-align:center;"><?php echo $title;?></td>
           <td style="width:200px; text-align:center;"><?php echo $fa;?></td>
...
?>
  ...
  require ('../models/dbcon.php');
  if(isset($_POST['submit1'])){
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.month_pub,i.volume_pub,i.pp,i.index_pub,i.web_of_science from staff_academics a,staff_publication i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.month_pub");
    if(mysqli_num_rows($sql) != null){
    $s =1;?>
    ...
    <table class="table table-sm table-bordered">
          <thead class="table-sm table-success">
            <tr>
              ...
              <th style="width:100px; text-align:center;">Web of Sciecne Indexed</th>
              </tr>
         </thead>
    <?php
    while($row = mysqli_fetch_array($sql)){
...
if(isset($_POST['GetAll'])){
  $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.month_pub,i.volume_pub,i.pp,i.index_pub,i.web_of_science from staff_academics a,staff_publication i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' and i.month_pub between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc");
  if(mysqli_num_rows($sql) != null){
  $s =1;?>
  <b>Journal Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
require ('../models/dbcon.php');
if(isset($_POST['submit1'])){
  $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.date_con");
 if(mysqli_num_rows($sql) != null){
 $s =1;?>
 ...
 <table class="table table-sm table-bordered">
       <thead class="table-sm table-success">
         <tr>
           ...
           <th style="width:100px; text-align:center;">Staf Name</th>
           <th style="width:100px; text-align:center;">Designation</th>
 ...
 echo "";
  ...
  $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' and date_con between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc,i.date_con");
  if(mysqli_num_rows($sql) != null){
  $s =1;?>
  <b>Conference Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
?>
   ...
   <center>
    ...
    require ('../models/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.coauthor,i.publisher,i.edition,i.isbn,i.dateofpublication from staff_academics a,staff_book_published i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc, i.dateofpublication");
      if(mysqli_num_rows($sql) != null){
      $s =1;?>
      ...
      <table class="table table-sm table-bordered">
           <thead class="table-sm table-success">
             <tr>
               ...
               <th style="width:200px; text-align:center;">DateOfPublication</th>
    ...
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.coauthor,i.publisher,i.edition,i.isbn,i.dateofpublication from staff_academics a,staff_book_published i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' and i.dateofpublication between '".$_POST['from']."' and '".$_POST['to']."'order by a.Designation desc, i.dateofpublication");
    if(mysqli_num_rows($sql) != null){
    $s =1;?>
    <b>Book Published Details</b><p>&nbsp;</p>
    <table class="table table-sm table-bordered">
  ...
  <center>
   ...
   require ('../models/dbcon.php');
   if(isset($_POST['submit1'])){
     $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.type,i.title,i.actedas,i.from_date,i.to_date,i.organizer from staff_academics a,staff_resource i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.from_date");
     if(mysqli_num_rows($sql) != null){
     $s =1;?>
     ...
     while($row = mysqli_fetch_array($sql)){
       ...
       $s++;
         ...
         $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.type,i.title,i.actedas,i.from_date,i.to_date,i.organizer from staff_academics a,staff_resource i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc,i.from_date");
         if(mysqli_num_rows($sql) != null){
         $s =1;?>
         <b>Resource Person Details</b><p>&nbsp;</p>
         <table class="table table-sm table-bordered">
 ...
 <center>
  ...
  require ('../models/dbcon.php');
  if(isset($_POST['submit1'])){
    $sql = mysqli_query($conn,"select distinct a.Department,a.Designation,i.staff_name,i.awardname,i.awardby,i.event,i.awa_date from staff_academics a,staff_award i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.awa_date");
    if(mysqli_num_rows($sql) != null){
    $s =1;?>
    ...
    $sql = mysqli_query($conn,"select distinct a.Department,a.Designation,i.staff_name,i.awardname,i.awardby,i.event,i.awa_date from staff_academics a,staff_award i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' and i.awa_date between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc,i.awa_date");
    if(mysqli_num_rows($sql) != null){
    $s =1;?>
    <b>Award Details</b><p>&nbsp;</p>
    <table class="table table-sm table-bordered">
 ...
 <center>
    <?php
      require ('../models/dbcon.php');
      if(isset($_POST['submit1'])){
        $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.patent,i.institution,i.generation,i.propose from staff_academics a,staff_ipr i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.generation");
        if(mysqli_num_rows($sql) != null){
$s =1;?>
...
<table class="table table-sm table-bordered">
    <thead class="table-sm table-success">
      <tr>
        ...
        <th style="width:100px; text-align:center;">Purpose</th>
        </tr>
   </thead>
<?php
while($row = mysqli_fetch_array($sql)){
...
?>
  ...
  $s++;
    ...
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.patent,i.institution,i.generation,i.propose from staff_academics a,staff_ipr i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' and generation between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc,i.generation");
    if(mysqli_num_rows($sql) != null){
$s =1;?>
<b>Intelletual property Right</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
<center>
     ...
     require ('../models/dbcon.php');
     if(isset($_POST['submit1'])){
       $sql = mysqli_query($conn,"select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.from_date");
       if(mysqli_num_rows($sql) != null){
$s =1;?>
...
$s++;
 ...
 ?>
   ...
   <center>
    ...
    require ('../models/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_certificate i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.data_of_exam");
if(mysqli_num_rows($sql) != null){
$s =1;?>
<b>Online Certification Course</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
     <thead class="table-sm table-success">
       <tr>
         <th style="width:30px;">SNO</th>
...
<td><?php echo $s;?></td>
<td style="width:200px; text-align:center;"><?php echo $name;?></td>
<td style="width:200px; text-align:center;"><?php echo $de;?></td>
<td style="width:200px; text-align:center;"><?php echo $des;?></td>
<td style="width:200px; text-align:center;"><?php echo $dep;?></td>
<td style="width:200px; text-align:center;"><?php echo $type;?></td>
<td style="width:200px; text-align:center;"><?php echo $title;?></td>
...
$s++;
    ...
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_certificate i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' and i.data_of_exam between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc,i.data_of_exam");
if(mysqli_num_rows($sql) != null){
$s =1;?>
<b>Online Certification Course</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
  ...
  <!-- Competative exam  -->
    <center>
     ...
     mysqli_set_charset($conn,"UTF8");
     if(isset($_POST['submit1'])){
       $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.exam_name,i.level,i.score,i.date_of_certificate from staff_academics a,staff_competitive i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.date_of_certificate");
  if(mysqli_num_rows($sql) != null){
  $s =1;?>
  ...
  $s++;
     ...
     $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.exam_name,i.level,i.score,i.date_of_certificate from staff_academics a,staff_competitive i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' and i.date_of_certificate between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc,i.date_of_certificate");
  if(mysqli_num_rows($sql) != null){
  $s =1;?>
  <b>Competitive Exam Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
  ...
  <center>
    ...
    require ('../models/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.project_title,i.description,i.from_date,i.to_date,i.status from staff_academics a,staff_innovative i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.from_date");
if(mysqli_num_rows($sql) != null){
$s =1;?>
...
<table class="table table-sm table-bordered">
     <thead class="table-sm table-success">
       <tr>
         ...
         <th style="width:300px; text-align:center;">From Date</th>
         <th style="width:300px; text-align:center;">To Date</th>
...
$s++;
    ...
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.project_title,i.description,i.from_date,i.to_date,i.status from staff_academics a,staff_innovative i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' and ((i.from_date between '".$_POST['from']."' and '".$_POST['to']."') or (i.to_date between '".$_POST['from']."' and '".$_POST['to']."')) order by a.Designation desc,i.from_date");
if(mysqli_num_rows($sql) != null){
$s =1;?>
<b>Innovative Project Details</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
   ...
   <center>
     <?php
        require ('../models/dbcon.php');
        if(isset($_POST['submit1'])){
          $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_id,i.res_id,i.staff_name,i.university,i.sup_name,i.desgination,i.organisation,i.status from staff_academics a,staff_scholars i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc");
          if(mysqli_num_rows($sql) != null){
   $s =1;?>
   ...
   <table class="table table-sm table-bordered">
       <thead class="table-sm table-success">
         <tr>
           ...
           <th style="width:100px; text-align:center;">Scholar Name</th>
           <th style="width:100px; text-align:center;">Designation</th>
...
$s++;
    ...
    <center>
         ...
         require ('../models/dbcon.php');
         if(isset($_POST['submit1'])){
           $sql = mysqli_query($conn,"select a.Department,a.Designation,i.res_sup_id,i.staff_id,i.staff_name,i.supj,i.university,i.internal,i.external,i.scholar from staff_academics a,staff_supervisor i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc");
           if(mysqli_num_rows($sql) != null){
    $s =1;?>
    ...
    <table class="table table-sm table-bordered">
        <thead class="table-sm table-success">
          <tr>
            ...
            <th style="width:100px; text-align:center;">Supervisor/Joint Supervisor</th>
            <th style="width:100px; text-align:center;">University</th>
            <th style="width:100px; text-align:center;">Internal Scholars</th>
            <th style="width:100px; text-align:center;">External Scholars</th>
            <th style="width:100px; text-align:center;">Number of Scholars Completed Ph.D</th>
            </tr>
       </thead>
    <?php
    while($row = mysqli_fetch_array($sql)){
...
?>
 ...
 $s++;
     ...
     ?>
       ...
       <tbody>
        ...
        $s++;
          ...
          $sql = mysqli_query($conn,"select a.Department,a.Designation,a.staff_name,i.staff_id,i.type,i.title,i.from_date,i.to_date,i.organizer,i.res_person,i.ben_person,i.sponsership,i.granted from staff_academics a,staff_event_organized i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc,i.from_date");
          if(mysqli_num_rows($sql) != null){
   $s =1;?>
   <b>Event Organized</b><p>&nbsp;</p>
   <table class="table table-sm table-bordered">
   ...
   <!-- <center>
    ...
    require ('../models/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.membershipid,i.organization from staff_academics a,staff_member i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc");
if(mysqli_num_rows($sql) != null){
$s =1;?>
