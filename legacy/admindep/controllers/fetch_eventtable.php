...
<body bgcolor="tan">
  ...
  <center><h3 style="color: #682D87;">Event Organized Details</h3></center>
     <hr>
     <div class="form-inline">
<a href="../views/eventtable.php"><button type="button" style=" cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
<div class="wrapper">
...
<input type="text" class="form-control col-sm-1" ng-model="ftext2" placeholder="Footer3">
     ...
     <div class="content">
       ...
       <?php include('../views/header.php');?><center>
         <?php
         $sql = mysqli_query($conn,"select distinct a.Department from staff_academics a,staff_event_organized i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."'");
         ...
         ?><br><div class="row">
           ...
           <div class="col">
             <b><span><label>Event Organised Report</label></span></b>
           </div>
           <div class="col">
         ...
         <?php
         $sql = mysqli_query($conn,"select distinct type from staff_event_organized where type='".$_POST['typ']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."'");
       while($row = mysqli_fetch_array($sql))  {
         $depts = $row['type'];?>
...
$sql = mysqli_query($conn,"select a.staff_name,a.Department,a.Designation,i.staff_id,i.type,i.title,i.from_date,i.to_date,i.organizer,i.res_person,i.ben_person,i.sponsership,i.granted from staff_academics a,staff_event_organized i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."' and i.type='".$_POST['typ']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."'order by a.Designation desc,i.from_date");
$s =1;
while($row = mysqli_fetch_array($sql)){
  $name = $row['staff_name'];
  $des = $row['Designation'];
