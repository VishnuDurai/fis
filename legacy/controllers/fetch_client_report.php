...
?>
  ...
  mysql_set_charset("utf8");
  if(isset($_POST['submit1'])){
    $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.type_pub,i.doi,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.type_pub='Journal'");
    if(mysql_num_rows($sql) != null){
    $s =1;?>
...
if(isset($_POST['GetAll'])){
mysql_set_charset("utf8");
  $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.type_pub,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.type_pub='Journal'");
    if(mysql_num_rows($sql) != null){
    $s =1;?>
    <b>Journal Publication Details</b><p>&nbsp;</p>
    <table class="table table-sm table-bordered">
...
mysql_set_charset("utf8");
if(isset($_POST['submit1'])){
  $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.type_pub,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.type_pub='Conference'");
 if(mysql_num_rows($sql) != null){
 $s =1;?>
 ...
 echo "";
  ...
  $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.type_pub,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.date_con between '".$_POST['from']."' and '".$_POST['to']."' and i.type_pub='Conference'");
  if(mysql_num_rows($sql) != null){
  $s =1;?>
  <b>Conference Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
?>
 ...
 $s++;
   ...
   $sql = mysql_query("select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.from_date between '".$_POST['from']."' and '".$_POST['to']."'");
   if(mysql_num_rows($sql) != null){
$s =1;?>
<b>Research and Development</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
    ...
    $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_certificate i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' and i.data_of_exam between '".$_POST['from']."' and '".$_POST['to']."'");
if(mysql_num_rows($sql) != null){
$s =1;?>
<b>Online Certificate Details</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
  ...
  <center>
   ...
   mysql_set_charset("utf8");
   if(isset($_POST['submit1'])){
     $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.exam_name,i.level,i.score,i.date_of_certificate from staff_academics a,staff_competitive i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
if(mysql_num_rows($sql) != null){
$s =1;?>
...
$s++;
   ...
   $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.exam_name,i.level,i.score,i.date_of_certificate from staff_academics a,staff_competitive i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' and i.date_of_certificate between '".$_POST['from']."' and '".$_POST['to']."'");
if(mysql_num_rows($sql) != null){
$s =1;?>
<b>Competitive Exam Details</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
