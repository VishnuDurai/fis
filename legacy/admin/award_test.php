...
<table class="table table-bordered table-sm table-hover table-striped" id="myTable" style=" margin-top: 40px;">
  ...
  <?php
  $sql = "select a.Department,a.Designation,i.id,i.file,i.staff_id,i.staff_name,i.awardname,i.awardby,i.event,i.awa_date,i.date from staff_academics a,staff_award i where i.staff_id=a.staff_id order by i.awa_date";
  ...
  <tbody class="table-warning">
    <tr>
      ...
      <td><?php echo $abc['awardname']?></td>
      <td><?php echo $abc['awardby']?></td>
      <td><?php echo $abc['event']?></td>
      <td><?php echo $abc['awa_date']?></td>
      <td><?php echo $abc['date']?></td>
      <td><a href="document/<?php echo $abc['file']; ?>" target="_blank">View</a></td>
      <td><?php echo "<a href='modify_award.php?id=$id&staff_id=$staff_id&staff_name=$staff_name&awardname=$awardname&awardby=$awardby&event=$event&file=$file'>Modify</a>" ?> </td>
    <td><?php echo "<a href='award_test.php?del=$abc[id]'>Delete</a>"; ?></td>
    </tr>
  </tbody>
  <?php
  }
