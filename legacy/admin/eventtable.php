...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="fetch_eventtable.php">
      ...
      <div class="form-container offset-sm-4">
        ...
        <div class="form-group">
          ...
          <select name="typ" class="form-control col-sm-6">
           ...
           <option>OTHER</option>
         </select><input type="submit" name="type" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Type Report"></div></div>
          <div class="form-group">
