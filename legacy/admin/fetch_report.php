...
<br>
    ...
    <center>
     ...
     if(isset($_POST['submit1'])){
       $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.type,i.title,i.from_date,i.to_date,i.organizer from staff_academics a,staff_interaction i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
     ...
     $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.type,i.title,i.from_date,i.to_date,i.organizer from staff_academics a,staff_interaction i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."'");
     if(mysqli_num_rows($sql) != null){
     $s =1;?>
     <b>Interaction Details</b><p>&nbsp;</p>
     <table class="table table-sm table-bordered">
...
?>
  ...
  mysqli_set_charset($conn,"UTF8");
  if(isset($_POST['submit1'])){
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.type_pub,i.doi,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.type_pub='Journal'");
    if(mysqli_num_rows($sql) != null){
    $s =1;?>
...
if(isset($_POST['GetAll'])){
  $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.type_pub,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.type_pub='Journal'");
    if(mysqli_num_rows($sql) != null){
    $s =1;?>
    <b>Journal Publication Details</b><p>&nbsp;</p>
    <table class="table table-sm table-bordered">
...
mysqli_set_charset($conn,"UTF8");
if(isset($_POST['submit1'])){
  $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.type_pub,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.type_pub='Conference'");
 if(mysqli_num_rows($sql) != null){
 $s =1;?>
 ...
 echo "";
  ...
  $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.type_pub,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.date_con between '".$_POST['from']."' and '".$_POST['to']."' and i.type_pub='Conference'");
  if(mysqli_num_rows($sql) != null){
  $s =1;?>
  <b>Conference Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
?>
   ...
   <center>
    ...
    mysqli_set_charset($conn,"UTF8");
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.coauthor,i.publisher,i.edition,i.isbn from staff_academics a,staff_book_published i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
      if(mysqli_num_rows($sql) != null){
      $s =1;?>
  ...
  <center>
   ...
   mysqli_set_charset($conn,"UTF8");
   if(isset($_POST['submit1'])){
     $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.type,i.title,i.actedas,i.from_date,i.to_date,i.organizer from staff_academics a,staff_resource i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
     if(mysqli_num_rows($sql) != null){
     $s =1;?>
     ...
     while($row = mysqli_fetch_array($sql)){
       ...
       $s++;
         ...
         $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.type,i.title,i.actedas,i.from_date,i.to_date,i.organizer from staff_academics a,staff_resource i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."'");
         if(mysqli_num_rows($sql) != null){
         $s =1;?>
         <b>Resource Person Details</b><p>&nbsp;</p>
         <table class="table table-sm table-bordered">
 ...
 <center>
  ...
  mysqli_set_charset($conn,"UTF8");
  if(isset($_POST['submit1'])){
    $sql = mysqli_query($conn,"select distinct a.Department,i.staff_name,i.awardname,i.awardby,i.event, i.awa_date from staff_academics a,staff_award i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
    if(mysqli_num_rows($sql) != null){
    $s =1;?>
    ...
    $sql = mysqli_query($conn,"select distinct a.Department,i.staff_name,i.awardname,i.awardby,i.event,i.awa_date from staff_academics a,staff_award i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' and i.awa_date between '".$_POST['from']."' and '".$_POST['to']."'");
    if(mysqli_num_rows($sql) != null){
    $s =1;?>
    <b>Award Details</b><p>&nbsp;</p>
    <table class="table table-sm table-bordered">
 ...
 <center>
    <?php
      ...
      mysqli_set_charset($conn,"UTF8");
      if(isset($_POST['submit1'])){
        $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.patent,i.institution,i.generation,i.propose from staff_academics a,staff_ipr i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
        if(mysqli_num_rows($sql) != null){
$s =1;?>
...
?>
  ...
  $s++;
    ...
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.patent,i.institution,i.generation,i.propose from staff_academics a,staff_ipr i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and generation between '".$_POST['from']."' and '".$_POST['to']."'");
    if(mysqli_num_rows($sql) != null){
$s =1;?>
<b>Intelletual Property Rights</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
<center>
     ...
     mysqli_set_charset($conn,"UTF8");
     if(isset($_POST['submit1'])){
       $sql = mysqli_query($conn,"select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
       if(mysqli_num_rows($sql) != null){
$s =1;?>
...
$s++;
 ...
 ?>
   ...
   <center>
    ...
    mysqli_set_charset($conn,"UTF8");
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_certificate i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
if(mysqli_num_rows($sql) != null){
$s =1;?>
...
$s++;
    ...
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_certificate i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' and i.data_of_exam between '".$_POST['from']."' and '".$_POST['to']."'");
if(mysqli_num_rows($sql) != null){
$s =1;?>
<b>Online Certification Courses</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
  ...
  <center>
	...
	mysqli_set_charset($conn,"UTF8");
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.project_title,i.description,i.status,i.from_date, i.to_date from staff_academics a,staff_innovative i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
if(mysqli_num_rows($sql) != null){
$s =1;?>
...
$s++;
    ...
    $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.project_title,i.description,i.from_date,i.to_date,i.status from staff_academics a,staff_innovative i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' and i.from_date between '".$_POST['from']."' and '".$_POST['to']."'");
if(mysqli_num_rows($sql) != null){
$s =1;?>
<b>Innovative Project Details</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
    ...
    <center>
		 ...
		 mysqli_set_charset($conn,"UTF8");
         if(isset($_POST['submit1'])){
           $sql = mysqli_query($conn,"select a.Department,a.Designation,i.res_sup_id,i.staff_id,i.staff_name,i.university,i.internal,i.external,i.scholar from staff_academics a,staff_supervisor i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
           if(mysqli_num_rows($sql) != null){
    $s =1;?>
     ...
     ?>
       ...
       <center>
         <?php
            ...
            mysqli_set_charset($conn,"UTF8");
            if(isset($_POST['submit1'])){
              $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_id,i.type,i.title,i.from_date,i.to_date,i.organizer,i.res_person,i.ben_person,i.sponsership,i.granted from staff_academics a,staff_event_organized i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
              if(mysqli_num_rows($sql) != null){
       $s =1;?>
       ...
       <tbody>
        ...
        $s++;
          ...
          $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_id,i.type,i.title,i.from_date,i.to_date,i.organizer,i.res_person,i.ben_person,i.Sponsorship,i.granted from staff_academics a,staff_event_organized i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."'");
          if(mysqli_num_rows($sql) != null){
   $s =1;?>
   <b>Events Organized</b><p>&nbsp;</p>
   <table class="table table-sm table-bordered">
