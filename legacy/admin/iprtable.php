...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="fetch_iprtable.php">
     <center><h3 style="color: #682D87;">Intellectual Property Right Details</h3></center>
      ...
      <div class="form-container offset-sm-4">
        <div class="form-group">
         ...
         <input type="submit" name="GetDate" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Periodic Report"></div></div>
         <div class="form-group">
