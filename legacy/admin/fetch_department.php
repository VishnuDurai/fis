...
<a href="./individual_department.php"><button type="button" style=" cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
<div class="wrapper">
...
?>
   ...
   <center>
    ...
    require ('../models/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.title,i.coauthor,i.publisher,i.edition,i.isbn from staff_academics a,staff_book_published i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc");
      if(mysqli_num_rows($sql) != null){
      $s =1;?>
