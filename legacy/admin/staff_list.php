...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="fetch_staff_list.php">
     <center><h3 style="color: #682D87;">Staff List</h3></center>
      ...
      <div class="form-container offset-sm-4">
       ...
       </select><input type="submit" name="typ" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Type Report"></div></div>
     <div class="form-group">
       ...
       <select name="dept" class="form-control col-sm-6">
        ...
        </select><input type="submit" name="GetDept" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Department Report"></div></div>
        <div class="form-group">
          <label style="color: white;">Qualification</label>
          <div class="form-inline">
            <select name="qua" class="form-control col-sm-6">
            <option value="#">------------</option>
            <option>M.phil</option>
            <option>MBA</option>
            <option>Ph.d</option>
          </select><input type="submit" name="qua_btn" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Qualification Report">
        </div>
        </div>
        <br>
        ...
        <input type="submit" class="btn btn-success" style="cursor:pointer;" name="submit2" value="Department Qualification Report">&nbsp;&nbsp;
