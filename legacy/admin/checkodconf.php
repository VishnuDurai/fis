...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="OD2.php">
     <center><h3 style="color: #682D87;">Conference Details</h3></center>
      <hr>
      <div class="form-container offset-sm-4">
         ...
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" class="btn btn-warning" style="cursor:pointer;" name="submit1" value="Submit">
</div>
    </div><br>
      <br><hr>
</form>
