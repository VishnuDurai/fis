...
<div class="form-control"><br>
			<center><h3 style="color: #682D87;" class="form-group">Manage Admin User </h3></center><hr>
		<table align="center">
...
<tr><td>&nbsp;</td><td><br>
  <input type="submit" class="btn btn-outline-success" onclick="window.location.reload(true)" style="cursor: pointer;" name="submit" value="Update"></td><td><br><center>
	<a href="admin_user.php"><button type="button" style="cursor: pointer;" class="btn btn-outline-primary">Back</button></center></td></tr>
</table><br>
</div>
</form>
<hr>
...
if(isset($_GET['staff_id'])){
  if(isset($_POST['submit'])){
    $id = $_GET['staff_id'];
    $type = $_POST['password'];
    $sql = mysql_query("update admin set password='$type' where staff_id='$id'");
if($sql){?>
	<script>
