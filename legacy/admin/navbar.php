    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="checkodres.php">Check OD-Resource Person</a>
     ...
     <!-- <li class="nav-item active">
       ...
       <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="admin_user.php">Manage Admin User </a>
          <a class="dropdown-item" href="admindep_user.php">Manage Department Admin User </a>
      ...
      <li class="nav-item dropdown active">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
          ...
          <a class="dropdown-item" href="innovativetable.php">Innovative Project Details</a>
          <a class="dropdown-item" href="competitivetable.php">Competitive Exam Details</a>
          ...
          <a class="dropdown-item" href="individual_department.php">Consolidated Department Report</a>
