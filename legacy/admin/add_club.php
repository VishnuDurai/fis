...
<div id="page">
	...
	<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">ADD NEW CLUB</marquee></b></div>
	<form action="add_club.php" method="post"><hr>
...
<tr><td>New Club :</td>
<td><input type="text" class="form-control" name="club_name" style='background-color:white; font-weight:bold;' required></td></tr>
...
if(isset($_POST['add_club'])){
  ...
  $sql = mysql_query("insert into club (id,club_name) values ('$id','$club')");
}
