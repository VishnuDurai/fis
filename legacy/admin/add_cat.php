...
<div id="page">
	...
	<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">ADD NEW DEGREE</marquee></b></div>
	<form action="add_cat.php" method="post"><hr>
    <div class="form-control"><br>
	<center><h3 style="color: #682D87;">New Degree</h3></center><hr>
	<table align="center">
<tr><td>Add new Degree:</td>
<td><input type="text" class="form-control" name="deg_name" style='background-color:white; font-weight:bold;' required></td></tr>
...
if(isset($_POST['add_club'])){
  $id = $_POST['id'];
  $club = $_POST['deg_name'];
 $sql = mysql_query("insert into degree (id,deg_name) values ('$id','$club')");
	if($sql){
