...
<a href="cpublicationtable.php"><button type="button" style="margin-left: 30px; cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
<div class="wrapper">
...
$sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' order by a.Designation desc,i.date_con");
  $s =1;
  while($row = mysql_fetch_array($sql)){
    $name = $row['staff_name'];
    $des = $row['Department'];
...
$sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and date_con between '".$_POST['from']."' and '".$_POST['to']."' order by a.Department,a.Designation desc,i.date_con");
$s =1;
while($row = mysql_fetch_array($sql)){
  $name = $row['staff_name'];
  $des = $row['Department'];
...
$sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."' and i.date_con between '".$_POST['from']."' and '".$_POST['to']."' order by a.Designation desc,i.date_con");
$s =1;
while($row = mysql_fetch_array($sql)){
  $name = $row['staff_name'];
  $des = $row['Department'];
  ...
  $s++;
      ...
      $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id order by a.Department,a.Designation desc,i.date_con");
      $s =1;
      while($row = mysql_fetch_array($sql)){
        $name = $row['staff_name'];
        $des = $row['Department'];
