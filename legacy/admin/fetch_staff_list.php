...
<body bgcolor="tan">
  ...
  <center><h3 style="color: #682D87;">Staff List</h3></center>
     <hr>
     <div class="form-inline">
<a href="staff_list.php"><button type="button" style=" cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
<div class="wrapper">
...
<input type="text" class="form-control col-sm-1" ng-model="ftext2" placeholder="Footer3">
     ...
     <div class="content">
      ...
      <b><label class="offset-sm-1">Department of</label>&nbsp;<?php echo $dep;?></b>
        ...
        ?>
         <?php
         $sql = mysql_query("select distinct i.type from staff_academics a,staff_personal i where a.staff_id=i.staff_id and i.type='".$_POST['type']."'");
         while($row = mysql_fetch_array($sql))  {
         $dep = $row['type'];?>
         <b><label class="offset-sm-1"></label>&nbsp;<?php echo $dep;?></b>
         <?php
         }
         ?><br><div class="row">
           <div class="col">
           ...
           <div class="col">
             <b><span><label>Staff Report</label></span></b>
           </div>
           <div class="col">
...
<table class="table table-sm table-bordered">
         <thead class="table-sm table-success">
           <tr>
             ...
             <th style="width:100px; text-align:center;">Type Of Faculty</th>
        ...
        require ('DB/dbcon.php');
        if(isset($_POST['typ'])){
$sql = mysql_query("select a.Department,a.Designation,a.Qualification,i.staff_name,i.staff_id,i.type from staff_academics a,staff_personal i where a.staff_id=i.staff_id and i.type='".$_POST['type']."'");
  $s =1;
  while($row = mysql_fetch_array($sql)){
    $name = $row['staff_id'];
    $des = $row['staff_name'];
  ...
  <tbody>
    ...
    <td style="width:200px; text-align:center;"><?php echo $qua;?></td>
   ...
   <?php
    $s++;
        ...
        $sql = mysql_query("select a.Department,a.Designation,a.Qualification,i.staff_name,i.staff_id,i.type from staff_academics a,staff_personal i where a.staff_id=i.staff_id and i.type='".$_POST['type']."' and a.Department='".$_POST['dept']."'");
        $s =1;
        while($row = mysql_fetch_array($sql)){
          $name = $row['staff_id'];
          $des = $row['staff_name'];
        ...
        $sql = mysql_query("select a.Department,a.Designation,a.Qualification,i.staff_name,i.staff_id,i.type from staff_academics a,staff_personal i where a.staff_id=i.staff_id and a.Department='".$_POST['dept']."'");
        $s =1;
        while($row = mysql_fetch_array($sql)){
          $name = $row['staff_id'];
          $des = $row['staff_name'];
      ...
      }if(isset($_POST['qua_btn'])){
        $sql = mysql_query("select a.Department,a.Designation,a.Qualification,i.staff_name,i.staff_id,i.type from staff_academics a,staff_personal i where a.staff_id=i.staff_id and a.Qualification='".$_POST['qua']."'");
        $s =1;
        while($row = mysql_fetch_array($sql)){
          $name = $row['staff_id'];
          $des = $row['staff_name'];
      ...
      $sql = mysql_query("select a.Department,a.Designation,a.Qualification,i.staff_name,i.staff_id,i.type from staff_academics a,staff_personal i where a.staff_id=i.staff_id and a.Qualification='".$_POST['qua']."' and a.Department='".$_POST['dept']."'");
      $s =1;
      while($row = mysql_fetch_array($sql)){
        $name = $row['staff_id'];
        $des = $row['staff_name'];
