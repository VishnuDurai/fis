...
<input type="text" class="form-control col-sm-1" ng-model="ftext2" placeholder="Footer3">
    ...
    <center>
     ...
     if(isset($_POST['submit1'])){
       $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.type,i.title,i.from_date,i.to_date,i.organizer from staff_academics a,staff_interaction i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'order by i.from_date");
     ...
     $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.type,i.title,i.from_date,i.to_date,i.organizer from staff_academics a,staff_interaction i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."' order by i.from_date");
     if(mysql_num_rows($sql) != null){
     $s =1;?>
     <b>Interaction Details</b><p>&nbsp;</p>
     <table class="table table-sm table-bordered">
...
?>
  ...
  require ('DB/dbcon.php');
  if(isset($_POST['submit1'])){
    $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.month_pub");
    if(mysql_num_rows($sql) != null){
    $s =1;?>
...
if(isset($_POST['GetAll'])){
  $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and month_pub between '".$_POST['from']."' and '".$_POST['to']."' order by i.month_pub");
  if(mysql_num_rows($sql) != null){
  $s =1;?>
  <b>Journal Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
require ('DB/dbcon.php');
if(isset($_POST['submit1'])){
  $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.date_con");
 if(mysql_num_rows($sql) != null){
 $s =1;?>
 ...
 echo "";
  ...
  $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and date_con between '".$_POST['from']."' and '".$_POST['to']."' order by i.date_con");
  if(mysql_num_rows($sql) != null){
  $s =1;?>
  <b>Conference Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
?>
  ...
  <center>
   ...
   require ('DB/dbcon.php');
   if(isset($_POST['submit1'])){
     $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.type,i.title,i.actedas,i.from_date,i.to_date,i.organizer from staff_academics a,staff_resource i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.from_date");
     if(mysql_num_rows($sql) != null){
     $s =1;?>
     ...
     while($row = mysql_fetch_array($sql)){
       ...
       $s++;
         ...
         $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.type,i.title,i.actedas,i.from_date,i.to_date,i.organizer from staff_academics a,staff_resource i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."' order by i.from_date");
         if(mysql_num_rows($sql) != null){
         $s =1;?>
         <b>Resource Person Details</b><p>&nbsp;</p>
         <table class="table table-sm table-bordered">
 ...
 <center>
  ...
  require ('DB/dbcon.php');
  if(isset($_POST['submit1'])){
    $sql = mysql_query("select distinct a.Department,i.staff_name,i.awardname,i.awardby,i.event,i.awa_date from staff_academics a,staff_award i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.awa_date");
    if(mysql_num_rows($sql) != null){
    $s =1;?>
    ...
    $sql = mysql_query("select distinct a.Department,i.staff_name,i.awardname,i.awardby,i.event,i.awa_date from staff_academics a,staff_award i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' and i.awa_date between '".$_POST['from']."' and '".$_POST['to']."' order by i.awa_date");
    if(mysql_num_rows($sql) != null){
    $s =1;?>
    <b>Award Details</b><p>&nbsp;</p>
    <table class="table table-sm table-bordered">
 ...
 <center>
    <?php
      require ('DB/dbcon.php');
      if(isset($_POST['submit1'])){
        $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.patent,i.institution,i.generation,i.propose from staff_academics a,staff_ipr i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.generation");
        if(mysql_num_rows($sql) != null){
$s =1;?>
...
?>
  ...
  $s++;
    ...
    $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.patent,i.institution,i.generation,i.propose from staff_academics a,staff_ipr i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and generation between '".$_POST['from']."' and '".$_POST['to']."' order by i.generation");
    if(mysql_num_rows($sql) != null){
$s =1;?>
<b>Intelletual property Right</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
<center>
     ...
     require ('DB/dbcon.php');
     if(isset($_POST['submit1'])){
       $sql = mysql_query("select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.from_date");
       if(mysql_num_rows($sql) != null){
$s =1;?>
...
$s++;
 ...
 ?>
   ...
   <center>
    ...
    require ('DB/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_certificate i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.data_of_exam");
if(mysql_num_rows($sql) != null){
$s =1;?>
...
$s++;
    ...
    $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_member i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.data_of_exam");
if(mysql_num_rows($sql) != null){
$s =1;?>
<b>Online Certificate Details</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
  ...
  <center>
    ...
    require ('DB/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.project_title,i.description,i.from_date,i.to_date,i.status from staff_academics a,staff_innovative i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.from_date");
if(mysql_num_rows($sql) != null){
$s =1;?>
...
$s++;
    ...
    <center>
         ...
         require ('DB/dbcon.php');
         if(isset($_POST['submit1'])){
           $sql = mysql_query("select a.Department,a.Designation,i.res_sup_id,i.staff_id,i.staff_name,i.supj,i.university,i.internal,i.external,i.scholar from staff_academics a,staff_supervisor i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
           if(mysql_num_rows($sql) != null){
    $s =1;?>
     ...
     ?>
       ...
       <center>
         <?php
            require ('DB/dbcon.php');
            if(isset($_POST['submit1'])){
              $sql = mysql_query("select a.Department,a.Designation,i.staff_id,i.type,i.title,i.from_date,i.to_date,i.organizer,i.res_person,i.ben_person,i.sponsership,i.granted from staff_academics a,staff_event_organized i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' order by i.from_date");
              if(mysql_num_rows($sql) != null){
       $s =1;?>
