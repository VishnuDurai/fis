...
<input type="text" class="form-control col-sm-1" ng-model="ftext2" placeholder="Footer3">
     ...
     <div class="content">
       ...
       <?php include('header.php');?>
         <br><div class="row">
           <div class="col">
             <?php
             $sql = mysql_query("select distinct staff_name,Department,Designation from staff_academics where staff_id='".$_POST['staffid']."'");
    ...
    <center>
     ...
     if(isset($_POST['submit1'])){
       $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.type,i.title,i.from_date,i.to_date,i.organizer from staff_academics a,staff_interaction i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
     ...
     $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.type,i.title,i.from_date,i.to_date,i.organizer from staff_academics a,staff_interaction i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."'");
     if(mysql_num_rows($sql) != null){
     $s =1;?>
     <b>Interaction Details</b><p>&nbsp;</p>
     <table class="table table-sm table-bordered">
...
?>
  ...
  require ('DB/dbcon.php');
  if(isset($_POST['submit1'])){
    $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
    if(mysql_num_rows($sql) != null){
    $s =1;?>
...
if(isset($_POST['GetAll'])){
  $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.doi,i.month_pub,i.volume_pub,i.pp from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and month_pub between '".$_POST['from']"' and '".$_POST['to']"'");
  if(mysql_num_rows($sql) != null){
  $s =1;?>
  <b>Journal Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
require ('DB/dbcon.php');
if(isset($_POST['submit1'])){
  $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
 if(mysql_num_rows($sql) != null){
 $s =1;?>
 ...
 echo "";
  ...
  $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.journel,i.date_con,i.organizer from staff_academics a,staff_publication i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and date_con between '".$_POST['from']."' and '".$_POST['to']."'");
  if(mysql_num_rows($sql) != null){
  $s =1;?>
  <b>Conference Publication Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
...
?>
   ...
   <center>
    ...
    require ('DB/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.title,i.coauthor,i.publisher,i.edition,i.isbn from staff_academics a,staff_book_published i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
      if(mysql_num_rows($sql) != null){
      $s =1;?>
  ...
  <center>
   ...
   require ('DB/dbcon.php');
   if(isset($_POST['submit1'])){
     $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.type,i.title,i.actedas,i.from_date,i.to_date,i.organizer from staff_academics a,staff_resource i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
     if(mysql_num_rows($sql) != null){
     $s =1;?>
     ...
     while($row = mysql_fetch_array($sql)){
       ...
       $s++;
         ...
         $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.type,i.title,i.actedas,i.from_date,i.to_date,i.organizer from staff_academics a,staff_resource i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and to_date between '".$_POST['from']."' and '".$_POST['to']."'");
         if(mysql_num_rows($sql) != null){
         $s =1;?>
         <b>Resource Person Details</b><p>&nbsp;</p>
         <table class="table table-sm table-bordered">
 ...
 <center>
  ...
  require ('DB/dbcon.php');
  if(isset($_POST['submit1'])){
    $sql = mysql_query("select distinct a.Department,i.staff_name,i.awardname,i.awardby,i.event from staff_academics a,staff_award i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
    if(mysql_num_rows($sql) != null){
    $s =1;?>
 ...
 <center>
    <?php
      require ('DB/dbcon.php');
      if(isset($_POST['submit1'])){
        $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.patent,i.institution,i.generation,i.propose from staff_academics a,staff_ipr i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
        if(mysql_num_rows($sql) != null){
$s =1;?>
...
?>
  ...
  $s++;
    ...
    $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.patent,i.institution,i.generation,i.propose from staff_academics a,staff_ipr i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and generation between '".$_POST['from']."' and '".$_POST['to']."'");
    if(mysql_num_rows($sql) != null){
$s =1;?>
<b>Intelletual property Right</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
<center>
     ...
     require ('DB/dbcon.php');
     if(isset($_POST['submit1'])){
       $sql = mysql_query("select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."'");
       if(mysql_num_rows($sql) != null){
$s =1;?>
...
?>
 ...
 $s++;
   ...
   $sql = mysql_query("select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and i.staff_id='".$_POST['staffid']."' and i.to_date between '".$_POST['from']."' and '".$_POST['to']."'");
   if(mysql_num_rows($sql) != null){
$s =1;?>
<b>Research and Development</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
 ...
 ?>
   ...
   <center>
    ...
    require ('DB/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_certificate i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
if(mysql_num_rows($sql) != null){
$s =1;?>
...
$s++;
    ...
    $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.course_name,i.mark,i.organisation,i.data_of_exam from staff_academics a,staff_member i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
if(mysql_num_rows($sql) != null){
$s =1;?>
<b>Online Certificate Details</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
  ...
  <!-- Competative exam  -->
    <center>
     ...
     if(isset($_POST['submit1'])){
       $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.exam_name,i.level,i.score,i.date_of_certificate from staff_academics a,staff_competitive i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
  ...
  $s++;
     ...
     $sql = mysqli_query($conn,"select a.Department,a.Designation,i.staff_name,i.exam_name,i.level,i.score,i.date_of_certificate from staff_academics a,staff_competitive i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' and i.date_of_certificate between '".$_POST['from']."' and '".$_POST['to']."'");
  if(mysqli_num_rows($sql) != null){
  $s =1;?>
  <b>Competitive Exam Details</b><p>&nbsp;</p>
  <table class="table table-sm table-bordered">
  ...
  <center>
    ...
    require ('DB/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.project_title,i.description,i.status from staff_academics a,staff_innovative i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
if(mysql_num_rows($sql) != null){
$s =1;?>
...
$s++;
    ...
    $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.project_title,i.description,i.status from staff_academics a,staff_innovative i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."' and ((i.from_date between '".$_POST['from']."' and '".$_POST['to']."') or (i.to_date between '".$_POST['from']."' and '".$_POST['to']."'))");
if(mysql_num_rows($sql) != null){
$s =1;?>
<b>Innovative Project Details</b><p>&nbsp;</p>
<table class="table table-sm table-bordered">
...
$s++;
   ...
   <center>
     <?php
        require ('DB/dbcon.php');
        if(isset($_POST['submit1'])){
          $sql = mysql_query("select a.Department,a.Designation,i.staff_id,i.res_id,i.staff_name,i.university,i.sup_name,i.desgination,i.organisation,i.status from staff_academics a,staff_scholars i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
          if(mysql_num_rows($sql) != null){
   $s =1;?>
...
$s++;
    ...
    <center>
         ...
         require ('DB/dbcon.php');
         if(isset($_POST['submit1'])){
           $sql = mysql_query("select a.Department,a.Designation,i.res_sup_id,i.staff_id,i.staff_name,i.university,i.internal,i.external,i.scholar from staff_academics a,staff_supervisor i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
           if(mysql_num_rows($sql) != null){
    $s =1;?>
...
?>
 ...
 $s++;
     ...
     ?>
       ...
       <center>
         <?php
            require ('DB/dbcon.php');
            if(isset($_POST['submit1'])){
              $sql = mysql_query("select a.Department,a.Designation,i.staff_id,i.type,i.title,i.from_date,i.to_date,i.organizer,i.res_person,i.ben_person,i.sponsership,i.granted from staff_academics a,staff_event_organized i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
              if(mysql_num_rows($sql) != null){
       $s =1;?>
   ...
   <center>
    ...
    require ('DB/dbcon.php');
    if(isset($_POST['submit1'])){
      $sql = mysql_query("select a.Department,a.Designation,i.staff_name,i.membershipid,i.organization from staff_academics a,staff_member i where a.staff_id=i.staff_id and i.staff_id='".$_POST['staffid']."'");
if(mysql_num_rows($sql) != null){
$s =1;?>
