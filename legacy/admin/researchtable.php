...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="fetch_research.php">
     ...
     <div class="form-group">
       ...
       <select name="dept" class="form-control col-sm-6">
          ...
          </select>&nbsp;&nbsp;<input type="submit" name="GetType" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Type Report"></div></div>
          <div class="form-group">
        ...
        <input type="submit" class="btn btn-warning" style="cursor:pointer;" name="submit2" value="Status Type Report">
      </div>
    </div><br>
      <br><hr>
</form>
