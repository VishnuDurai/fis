...
<a href="professionaltable.php"><button type="button" style="cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
<div class="wrapper">
...
<input type="text" class="form-control col-sm-1" ng-model="ftext2" placeholder="Footer3">
     ...
     <div class="content">
       ...
       <?php include('header.php');?><center>
         <?php
         $sql = mysql_query("select distinct a.Department from staff_academics a,staff_member i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."'");
         while($row = mysql_fetch_array($sql)) {
           ...
           ?><?php
           $sql = mysql_query("select distinct a.Department,i.staff_id from staff_academics a,staff_member i where a.staff_id = i.staff_id and i.staff_id='".$_POST['id']."'");
           while($row = mysql_fetch_array($sql)) {
             $dep = $row['Department'];
             $id = $row['staff_id'];?>
             <b><label class="offset-sm-1">Department of</label>&nbsp;<?php echo $dep;?></b>
...
$sql = mysql_query("select a.Department,a.Designation,i.staff_id,i.staff_name,i.membershipid,i.organization from staff_academics a,staff_member i where a.staff_id=i.staff_id order by a.Department,a.Designation desc");
  $s =1;
  while($row = mysql_fetch_array($sql)){
  ...
  <tbody>
   ...
   <?php
    $s++;
        ...
        $sql = mysql_query("select a.Department,a.Designation,i.staff_id,i.staff_name,i.membershipid,i.organization from staff_academics a,staff_member i where a.staff_id=i.staff_id and staff_id='".$_POST['id']."'");
        $s =1;
        while($row = mysql_fetch_array($sql)){
          $staffname = $row['staff_name'];
          $des=$row['Designation'];
        ...
        $sql = mysql_query("select a.Department,a.Designation,i.staff_id,i.staff_name,i.membershipid,i.organization from staff_academics a,staff_member i where a.staff_id=i.staff_id and i.organization='".$_POST['organization']."' order by a.Department,a.Designation desc");
        $s =1;
        while($row = mysql_fetch_array($sql)){
          $staffname = $row['staff_name'];
          $des=$row['Designation'];
        ...
        $sql = mysql_query("select a.Department,a.Designation,i.staff_id,i.staff_name,i.membershipid,i.organization from staff_academics a,staff_member i where a.staff_id=i.staff_id and Department='".$_POST['dept']."'");
        $s =1;
        while($row = mysql_fetch_array($sql)){
          $staffname = $row['staff_name'];
          $des=$row['Designation'];
