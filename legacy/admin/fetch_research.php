...
<body bgcolor="tan">
  ...
  <center><h3 style="color: #682D87;">Research Development Details</h3></center>
     <hr>
     <div class="form-inline">
 <a href="researchtable.php"><button type="button" style=" cursor: pointer;" class="btn btn-outline-danger btn-sm"> Back </button></a>
 <div class="wrapper">
...
<input type="text" class="form-control col-sm-1" ng-model="ftext2" placeholder="Footer3">
     ...
     <div class="content">
       ...
       <?php include('header.php');?><center>
         <?php
         $sql = mysql_query("select distinct a.Department from staff_academics a,staff_interaction i where a.staff_id = i.staff_id and a.Department='".$_POST['dept']."'");
         ...
         ?><br><div class="row">
           ...
           <div class="col">
             <b><span><label>Research Development Report</label></span></b>
           </div>
           <div class="col">
         ...
         <?php
         $sql = mysql_query("select distinct type from staff_development where type='".$_POST['Type']."'");
       while($row = mysql_fetch_array($sql))  {
         $depts = $row['type'];?>
...
<table class="table table-sm table-bordered">
         <thead class="table-sm table-success">
           <tr>
             ...
             <th style="width:100px; text-align:center;">Co-Investigator</th>
             ...
             <th style="width:100px; text-align:center;">Academic Year</th>
...
$sql = mysql_query("select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and Department='".$_POST['dept']."'order by a.Designation desc,i.from_date");
$s =1;
while($row = mysql_fetch_array($sql)){
  $name = $row['staff_name'];
  $des = $row['Designation'];
  ...
  $s++;
      ...
      $sql = mysql_query("select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and i.type='".$_POST['Type']."' order by a.Department,a.Designation desc,i.from_date");
      $s =1;
      while($row = mysql_fetch_array($sql)){
        $name = $row['staff_name'];
        $des = $row['Designation'];
...
while($row = mysql_fetch_array($sql)){
  ...
  $sql = mysql_query("select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and i.type='".$_POST['Type']."' and a.Department='".$_POST['dept']."' and ((i.from_date between '".$_POST['from']."' and '".$_POST['to']."') or (i.to_date between '".$_POST['from']."' and '".$_POST['to']."')) order by a.Designation desc,i.from_date");
  $s =1;
  while($row = mysql_fetch_array($sql)){
    $name = $row['staff_name'];
    $des = $row['Designation'];
    ...
    if(isset($_POST['submit2'])){
      $sql = mysql_query("select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id and i.type='".$_POST['Type']."' and i.status='On Going' order by a.Department,a.Designation desc,i.from_date");
      $s =1;
      while($row = mysql_fetch_array($sql)){
        $name = $row['staff_name'];
        $des = $row['Designation'];
  ...
  $sql = mysql_query("select a.Department,a.Designation,i.type,i.staff_name,i.coname,i.title,i.from_date,i.to_date,i.year_aca,i.status,i.institution,i.revenue from staff_academics a,staff_development i where a.staff_id = i.staff_id order by a.Department,a.Designation desc,i.from_date");
  $s =1;
  while($row = mysql_fetch_array($sql)){
    $name = $row['staff_name'];
    $des = $row['Designation'];
