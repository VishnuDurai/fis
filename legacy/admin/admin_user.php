...
<thead class="table-success"><tr>
  ...
  <?php
  $sql = "select a.Department,a.Designation,a.staff_name,i.staff_id,i.password from staff_academics a,admin i where i.staff_id=a.staff_id";
 $result = mysql_query($sql);
  ...
  <tbody class="table-warning">
    ...
    <td><?php echo "<a href='modify_admin.php?staff_id=$id&staff_name=$staff_name&Department=$awardname&Designation=$awardby&password=$file'>Modify</a>" ?> </td>
    <td><?php echo "<a href='admin_user.php?del=$abc[staff_id]'>Delete</a>"; ?></td>
    </tr>
  </tbody>
  <?php
  }
...
if($result)
{
  ...
  alert('successfully Deleted');
        window.location.href='admin_user.php?success';
        </script>
  <?php
}
else
{
  ...
  <script>
  alert('error');
        window.location.href='admin_user.php?fail';
        </script>
  <?php
}
