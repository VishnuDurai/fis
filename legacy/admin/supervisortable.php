...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="fetch_supervisor.php">
      ...
      <div class="form-container offset-sm-4">
        ...
        <div class="form-group">
          ...
          <select name="dept" class="form-control col-sm-6">
           ...
           </select><input type="submit" name="GetDept" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Department Report"></div></div><br>
