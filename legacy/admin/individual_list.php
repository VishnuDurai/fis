...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="fetch_staff_individual.php">
      ...
      <div class="form-container offset-sm-4">
        <div class="form-group">
          ...
          <div class="form-inline">
            ...
            <input type="submit" class="btn btn-info" style="cursor:pointer;" name="submit1" value="Staff Report">
          </div>
        </div>
    <!-- <div class="form-group">
       ...
       <a href="staff.php"><input type="button" class="btn btn-danger" style="cursor:pointer;" value="BACK"></a>
         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <input type="submit" class="btn btn-warning" style="cursor:pointer;" name="GetAll" value="Periodic Staff Report">&nbsp;&nbsp;
      </div>
    </div><br>
      <br><hr>
</form>
