...
<div class="container">
  ...
  <!--<div style="color: #682D87;" class="news"><b><marquee behavior="alternate">Interaction Report</marquee></b></div><hr>-->
    <form method="post" action="fetch_jpublication.php">
     <center><h3 style="color: #682D87;">Journal Publication Details</h3></center>
      ...
      <div class="form-container offset-sm-4">
        <div class="form-group">
         ...
         <div class="form-inline">
         <input type="month" class="form-control col-sm-4"  name="from"><input type="submit" name="GetDate" class="btn btn-info offset-sm-1" style="cursor:pointer;" value="Periodic Report"></div></div>
         <div class="form-group">
        ...
        <input type="submit" class="btn btn-warning" style="cursor:pointer;" name="submit1" value="Institution Reports">
</div>
    </div><br>
      <br><hr>
</form>
